...
export const ISO4217Codes = new Set(currencySelectOptions.map((option) => option.value));
...
export const ISO31661Alpha2CountryCodes = new Set([
  'AD',
  'AE',
  'AF',
  'AG',
...
export const ISO31662USCodes = new Set([
  'AL',
  'AK',
  'AZ',
  'AR',
...
export const genders = new Set(['Male', 'Female', 'Non-Binary', 'Other']);
